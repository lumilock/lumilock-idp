...
export class myInit1645542039161 implements MigrationInterface {
    name = 'myInit1645542039161'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "clients" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "is_active" boolean NOT NULL DEFAULT true, "is_archived" boolean NOT NULL DEFAULT false, "create_date_time" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "last_changed_date_time" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "client_name" character varying(200) NOT NULL, "secret" character varying(200) NOT NULL, "redirect_uris" text NOT NULL, "application_type" "public"."clients_application_type_enum" NOT NULL DEFAULT 'web', "logo_uri" character varying(300), CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`);
