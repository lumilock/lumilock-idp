...
export class myInit1667380089106 implements MigrationInterface {
    name = 'myInit1667380089106'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users_clients" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "role" "public"."users_clients_role_enum" NOT NULL DEFAULT 'guest', "authorization" boolean NOT NULL DEFAULT false, "favorite" boolean NOT NULL DEFAULT false, "permissions" text NOT NULL, "user_id" uuid NOT NULL, "client_id" uuid NOT NULL, "create_date_time" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "last_changed_date_time" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_04e047a4375832031896bb4d59d" UNIQUE ("user_id", "client_id"), CONSTRAINT "PK_c03bca848864dcc060fcdc46e7c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."clients_application_type_enum" AS ENUM('web', 'native')`);
        await queryRunner.query(`CREATE TABLE "clients" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "is_active" boolean NOT NULL DEFAULT true, "is_archived" boolean NOT NULL DEFAULT false, "create_date_time" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "last_changed_date_time" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "client_name" character varying(200) NOT NULL, "secret" character varying(200) NOT NULL, "appUrl" character varying(200), "hide" boolean NOT NULL DEFAULT true, "redirect_uris" text NOT NULL, "permissions" text NOT NULL, "application_type" "public"."clients_application_type_enum" NOT NULL DEFAULT 'web', "logo_uri" character varying(300), CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`);
