...
export class UsersDetailedDTO implements Readonly<UsersDetailedDTO> {
  ...
  public static from(dto: Partial<UsersDetailedDTO>): UsersDetailedDTO {
    const user = new UsersDetailedDTO();
    user.id = dto.id;
  ...
  public static fromEntity(entity: User) {
    return this.from({
      ...
      address:
        entity?.addresses?.[0] &&
        AddressesDTO.fromEntity(entity?.addresses?.[0]),
